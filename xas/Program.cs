...
namespace com.redwine.xas
{
    class Program
    {
        ...
        private sealed class Options
        {
            ...
            [Option('p', "prefix",
                DefaultValue=false,
                HelpText = "Prefix accessors with set_ or get_ (default is false)")]
            ...
            [Option('o', "output",
                DefaultValue="xas_output",
                HelpText = "Specify the directory where translated files will be placed")]
            public string OutputDir { get; set; }

            [Option('z', "stdheaders",
                DefaultValue=false,
                HelpText = "Specify if standard C++ headers should be included")]
            public bool StdCppHeaders { get; set; }
