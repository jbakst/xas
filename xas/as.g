...
@parser::members {
	...
	private void demarcate(LinkedList<string> parent) {
...
unaryExpression
	...
	|	dec=DEC unaryExpression -> ^(PRE_DEC[$dec] unaryExpression)
...
postfixExpression
	:	(primaryExpression -> primaryExpression)
		...
		( 	inc=INC -> ^(POST_INC[$inc] $postfixExpression)
	 	|	dec=DEC -> ^(POST_DEC[$dec] $postfixExpression)
		)?
 	;
