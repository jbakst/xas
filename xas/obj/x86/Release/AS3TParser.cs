...
public partial class AS3TParser : Antlr.Runtime.Parser
{
	...
	private TemplateParserRuleReturnScope<StringTemplate, IToken> packageDecl()
	{
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				_namespace = (id!=null?input.ToString(id.Start,id.Stop):null);
			}
			DebugLocation(363, 3);
			...
			if (state.backtracking == 0)
			{
				// 365:10: -> file1(x=$textdefs=$packageBlockEntry.text)
				{
					...
					new Dictionary<string, object>() { {"x", input.ToString(retval.Start,input.LT(-1))}, {"defs", (packageBlockEntry1!=null?input.ToString(packageBlockEntry1.Start,packageBlockEntry1.Stop):null)} }
				);
				}
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				// 390:33: -> include(name=$identifierStar.text)
				{
					...
					new Dictionary<string, object>() { {"name", (identifierStar2!=null?input.ToString(identifierStar2.Start,identifierStar2.Stop):null)} }
				);
				}
	...
	private TemplateParserRuleReturnScope<StringTemplate, IToken> classDefinition()
	{
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				_classname = (ident3!=null?input.ToString(ident3.Start,ident3.Stop):null); 
			}
			DebugLocation(403, 3);
	...
	private TemplateParserRuleReturnScope<StringTemplate, IToken> classExtendsClause()
	{
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				_basetype = (identifier4!=null?input.ToString(identifier4.Start,identifier4.Stop):null); 
			}
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				// 451:53: -> interfaces(i=$i1.text)
				{
					...
					new Dictionary<string, object>() { {"i", (i1!=null?input.ToString(i1.Start,i1.Stop):null)} }
				);
				}
	...
	private TemplateParserRuleReturnScope<StringTemplate, IToken> methodDefinition()
	{
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
							...
							Symbol s = new Symbol();
							s.Name = (methodName5!=null?input.ToString(methodName5.Start,methodName5.Stop):null);
							s.EnclosingType = _classname;
							s.Kind = Symbol.FUNCTION;
							s.ArgList = (parameterDeclarationList6!=null?input.ToString(parameterDeclarationList6.Start,parameterDeclarationList6.Stop):null);
							s.Scope = _scope;
							s.Accessor = _accessor;
							s.ReturnType = (typeExpression7!=null?input.ToString(typeExpression7.Start,typeExpression7.Stop):null);
			...
			if (state.backtracking == 0)
			{
				// 509:3: -> method(class=_classnamename=$methodName.textret=$typeExpression.textargs=$parameterDeclarationList.textblock=$maybeBlock.textaccessor=$accessorRole.text)
				{
					...
					new Dictionary<string, object>() { {"class", _classname}, {"name", (methodName5!=null?input.ToString(methodName5.Start,methodName5.Stop):null)}, {"ret", (typeExpression7!=null?input.ToString(typeExpression7.Start,typeExpression7.Stop):null)}, {"args", (parameterDeclarationList6!=null?input.ToString(parameterDeclarationList6.Start,parameterDeclarationList6.Stop):null)}, {"block", (maybeBlock8!=null?input.ToString(maybeBlock8.Start,maybeBlock8.Stop):null)}, {"accessor", (accessorRole9!=null?input.ToString(accessorRole9.Start,accessorRole9.Stop):null)} }
				);
				}
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				// 551:50: -> decl2(name=$variableDeclarator.text)
				{
					...
					new Dictionary<string, object>() { {"name", (variableDeclarator10!=null?input.ToString(variableDeclarator10.Start,variableDeclarator10.Stop):null)} }
				);
				}
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				// 567:22: -> assign(rhs=$expression.text)
				{
					...
					new Dictionary<string, object>() { {"rhs", (expression11!=null?input.ToString(expression11.Start,expression11.Stop):null)} }
				);
				}
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				// 615:51: -> paramdecl(name=$ident.texttype=$typeExpression.textinit=$parameterDefault.text)
				{
					...
					new Dictionary<string, object>() { {"name", (ident14!=null?input.ToString(ident14.Start,ident14.Stop):null)}, {"type", (typeExpression15!=null?input.ToString(typeExpression15.Start,typeExpression15.Stop):null)}, {"init", (parameterDefault16!=null?input.ToString(parameterDefault16.Start,parameterDefault16.Stop):null)} }
				);
				}
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				// 627:32: -> param(name=$ident.texttype=$typeExpression.text)
				{
					...
					new Dictionary<string, object>() { {"name", (ident17!=null?input.ToString(ident17.Start,ident17.Stop):null)}, {"type", (typeExpression18!=null?input.ToString(typeExpression18.Start,typeExpression18.Stop):null)} }
				);
				}
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				// 708:10: -> catchBlock(t=$typeExpression.textid=$ident.textb=$block.text)
				{
					...
					new Dictionary<string, object>() { {"t", (typeExpression19!=null?input.ToString(typeExpression19.Start,typeExpression19.Stop):null)}, {"id", (ident20!=null?input.ToString(ident20.Start,ident20.Stop):null)}, {"b", (block21!=null?input.ToString(block21.Start,block21.Stop):null)} }
				);
				}
	...
	private TemplateParserRuleReturnScope<StringTemplate, IToken> expressionList()
	{
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				...
				{
					retval.Template = TemplateGroup.GetInstanceOf("assign",
					new Dictionary<string, object>() { {"rhs", (e1!=null?input.ToString(e1.Start,e1.Stop):null)} }
				);
				}
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				// 992:104: -> assignexpr(lhs=$x1.textop=$op1.textrhs=$x2.text)
				{
					...
					new Dictionary<string, object>() { {"lhs", (x1!=null?input.ToString(x1.Start,x1.Stop):null)}, {"op", (op1!=null?input.ToString(op1.Start,op1.Stop):null)}, {"rhs", (x2!=null?input.ToString(x2.Start,x2.Stop):null)} }
				);
				}
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				// 1079:64: -> expr(e=$s1.textr=$relationalOperator.textc=$s2.text)
				{
					...
					new Dictionary<string, object>() { {"e", (s1!=null?input.ToString(s1.Start,s1.Stop):null)}, {"r", (relationalOperator24!=null?input.ToString(relationalOperator24.Start,relationalOperator24.Stop):null)}, {"c", (s2!=null?input.ToString(s2.Start,s2.Stop):null)} }
				);
				}
		...
		try
		{
			...
			if (state.backtracking == 0)
			{
				// 1218:22: -> indirect(name=$qualifiedIdent.text)
				{
					...
					new Dictionary<string, object>() { {"name", (qualifiedIdent25!=null?input.ToString(qualifiedIdent25.Start,qualifiedIdent25.Stop):null)} }
				);
				}
			...
			case 1:
				...
				if (state.backtracking == 0)
				{
					// 1228:15: -> xml(x=$xmlLiteral.text)
					{
						...
						new Dictionary<string, object>() { {"x", (xmlLiteral26!=null?input.ToString(xmlLiteral26.Start,xmlLiteral26.Stop):null)} }
					);
					}
			...
			case 2:
				...
				if (state.backtracking == 0)
				{
					// 1229:19: -> regex(x=$regexpLiteral.text)
					{
						...
						new Dictionary<string, object>() { {"x", (regexpLiteral27!=null?input.ToString(regexpLiteral27.Start,regexpLiteral27.Stop):null)} }
					);
					}
	...
	public void synpred1_AS3T_fragment()
	{
	...
	public void synpred5_AS3T_fragment()
	{
	...
	public void synpred6_AS3T_fragment()
	{
	...
	public void synpred7_AS3T_fragment()
	{
	...
	public void synpred8_AS3T_fragment()
	{
	...
	public void synpred9_AS3T_fragment()
	{
	...
	public void synpred10_AS3T_fragment()
	{
	...
	public void synpred11_AS3T_fragment()
	{
	...
	public void synpred12_AS3T_fragment()
	{
	...
	public void synpred13_AS3T_fragment()
	{
	...
	public void synpred14_AS3T_fragment()
	{
	...
	public void synpred15_AS3T_fragment()
	{
	...
	public void synpred16_AS3T_fragment()
	{
